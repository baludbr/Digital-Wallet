...
urlpatterns = [
    ...
    path('insertid/',views.insertData,name='editprofile1'),
    path('users1/',views.users1,name="user"),
    path('query1/',views.query1,name="user1"),
    path('trans/',views.trans,name="user2"),
    path('logout/',views.logout,name="logout"),
    path('', views.main, name='main'),
    path('forgot/',views.forgotpassword_emailenter),
    path('forgot/otpconfirm/',views.forgotpassword_otp),
    path('otpcenter/',views.otp_verification1),
